...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <table>
    	...
    	<c:forEach items="${sessionScope.order.orderLines}" var="row" varStatus="rowCounter">
	    	<tr>
	    		...
	    		<form:form action="updateCart" modelAttribute="item" method="post">
		    		<td><form:input path="quantity" value="${row.quantity}" size="3"/></td>
	    		...
	    		<td>
					<form:form action="removeOrderLine" modelAttribute="item" method="post">
						<form:hidden path="foodItem.id" value="${row.foodItem.id}"/>
